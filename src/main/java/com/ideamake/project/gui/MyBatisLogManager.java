package com.ideamake.project.gui;

import com.ideamake.project.Icons;
import com.ideamake.project.action.ClearAllAction;
import com.ideamake.project.action.RerunAction;
import com.ideamake.project.action.StopAction;
import com.ideamake.project.utils.Env;
import com.ideamake.project.utils.NotifyUtils;
import com.ideamake.project.utils.ProjectContextHolder;
import com.ideamake.project.web.MyWebSocketClient;
...
public class MyBatisLogManager implements Disposable {
    ...
    public static final String ACTION_MSG = "{\"action\":\"read\",\"data\":\"%s\\r\"}";
    ...
    private static MyWebSocketClient createSocketConnection(String cmd, String agentId, String host, Env env, Editor editor) {
        ...
        MyWebSocketClient finalClient = client;
        new Thread(() -> {
            Optional.ofNullable(finalClient).ifPresent(WebSocketClient::connect);
        }).start();
